            ...
            <a href="/Quality-Reads#search-input-parent-container"
                ...
                <span class=" link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 511.975 512.075">
                        <path d="M416,208a207.488,207.488,0,0,1-40,122.7L502.6,457.4a32.032,32.032,0,0,1-45.3,45.3L330.7,376A206.808,206.808,0,0,1,208,416C93.1,416,0,322.9,0,208S93.1,0,208,0,416,93.1,416,208ZM208,352A144,144,0,1,0,64,208,144.037,144.037,0,0,0,208,352Z"
                            fill="currentColor" />
                    </svg>
                </span>
            ...
            <button class="menu-modal-btn web-links web-btns d-flex justify-content-center mobile-only">
                <span class="link-icon d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 74.207 63.606">
                        <path d="M0,69.3A5.3,5.3,0,0,1,5.3,64H68.906a5.3,5.3,0,0,1,0,10.6H5.3A5.3,5.3,0,0,1,0,69.3ZM0,95.8a5.3,5.3,0,0,1,5.3-5.3H68.906a5.3,5.3,0,1,1,0,10.6H5.3A5.3,5.3,0,0,1,0,95.8Zm74.207,26.5a5.3,5.3,0,0,1-5.3,5.3H5.3a5.3,5.3,0,0,1,0-10.6H68.906A5.3,5.3,0,0,1,74.207,122.305Z"
                ...
                <button class="close-modal-btn web-links web-btns d-flex justify-content-center mobile-only">
                    <span class="link-icon d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 54.241 54.241">
                            <path d="M52.561,105.188a5.427,5.427,0,0,0-7.675-7.675l-17.84,17.857L9.188,97.53a5.427,5.427,0,0,0-7.675,7.675l17.857,17.84L1.53,140.9a5.427,5.427,0,0,0,7.675,7.675l17.84-17.857L44.9,148.561a5.427,5.427,0,1,0,7.675-7.675l-17.857-17.84Z"
                    ...
                    <button class="user-modal-btn web-links web-btns d-flex justify-content-center">
                        <span class="link-icon d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 512 512">
                                <path d="M399,384.2A127.972,127.972,0,0,0,288,320H224a127.972,127.972,0,0,0-111,64.2,192.159,192.159,0,0,0,286,0ZM512,256c0,141.4-114.6,256-256,256S0,397.4,0,256,114.6,0,256,0,512,114.6,512,256ZM256,272a72,72,0,1,0-72-72A71.955,71.955,0,0,0,256,272Z"
                                    fill="currentColor" />
                            </svg>
                        </span>
                        ...
                        <a href="#" class="web-links d-flex justify-content-center">
                            <span class="link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 448 512">
                                    <path d="M224,256A128,128,0,1,0,96,128,127.99,127.99,0,0,0,224,256Zm-45.7,48A178.265,178.265,0,0,0,0,482.3,29.7,29.7,0,0,0,29.7,512H418.3A29.7,29.7,0,0,0,448,482.3,178.265,178.265,0,0,0,269.7,304Z"
                                        fill="currentColor" />
                                </svg>
                            </span>
                            ...
                            <button class="theme-modal-btn web-links web-btns d-flex justify-content-center">
                                <span class="link-icon d-flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        ...
                                        <path d="M190.489,108.851a81.659,81.659,0,0,0-81.638-81.638V190.489A81.659,81.659,0,0,0,190.489,108.851Zm27.213,0A108.851,108.851,0,1,1,108.851,0,108.843,108.843,0,0,1,217.7,108.851Z"
                                            fill="currentColor" />
                                    </svg>
                                </span>
                                ...
                                <button class="theme-btn web-links web-btns d-flex justify-content-center"
                                    ...
                                    <span class="link-icon d-flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            ...
                                            <path d="M100.395,32a100.619,100.619,0,1,0,69.984,172.76,7.18,7.18,0,0,0-6.244-12.218A79.069,79.069,0,0,1,111.894,45.79,7.175,7.175,0,0,0,108.929,32.4c-2.83-.225-5.66-.359-8.535-.359Z"

...
function cumulativeSharingFunc(url, heading) {
    ...
    if (navigator.share) {
        ...
        <div class="share-options-container d-flex d-flex-dir-col">
            <span class="dropdown-type-text">Share</span>
            ...
            <button class="share-option more-share-option d-flex">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 112 432">
                    <path d="M64,360A56,56,0,1,1,8,416,56.036,56.036,0,0,1,64,360Zm0-160A56,56,0,1,1,8,256,56.036,56.036,0,0,1,64,200ZM120,96A56,56,0,1,1,64,40,56.036,56.036,0,0,1,120,96Z" transform="translate(-8 -40)" fill="currentColor"/>
                </svg>
                <span class="share-option-text">More option</span>
            </button>
        </div>`;
...
function articleBlocksSharingFunc(container, url, heading) {
    ...
    if (navigator.share) {
        ...
        <button class="share-option close-share-option d-flex">
            ...
            <span class="share-option-text">Close</span>
        </button>`;
...
function quoteBlocksSharingFunc(container, heading, author) {

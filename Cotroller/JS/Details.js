...
function apiRunningFun(e) {
    fetch(e)
        ...
        .catch((error) => {
            ...
            <p>Opps faced error, we are doing our best to resolve<br>Try to <button onclick="location.reload();">Reload</button> page<br><a href="../Template/Index.html">Go to home page</a></p>
        </div>`
    });
}